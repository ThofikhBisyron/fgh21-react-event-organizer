...
async function home(searchValue){
  ...
  const dataHome = await fetch(`http://157.230.243.8:10001/events/${eventSearch}` ,{
    headers: {
...
useEffect(() =>{
  async function partnersData(){
    const eventfetch = await fetch("http://157.230.243.8:10001/partners/")
...
async function eventCategory() {
  const Categoryfetch = await fetch(`http://157.230.243.8:10001/categories/events/?id=${datacategory}&page=${page}&limit=3`)
